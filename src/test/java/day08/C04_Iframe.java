...
public class C04_Iframe {
    ...
    çalıştırabiliriz.*/
        ...
        WebElement youteubeFrame = driver.findElement(By.xpath("//*[@src='https://www.youtube.com/embed/owsfdh4gxyc']"));
        driver.switchTo().frame(youteubeFrame);
        driver.findElement(By.xpath("//*[@aria-label='Wiedergabe']")).click();




        //developer in kod degisikligine karsi boyle daha avantajli
